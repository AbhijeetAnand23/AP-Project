...
public class ChooseTanksPlayer1 implements Screen {
    ...
    public ChooseTanksPlayer1(TankStars game) {
        this.game = game;
        batch = new SpriteBatch();

        background = new Texture("ChooseTanksPlayer1.png");
        tank = new Texture("Tank1MainMenu.png");
        tankMini = new Texture("Tank1.png");
    ...
    public void render(float delta) {
        ...
        game.batch.draw(tank, 290,78, 600,600);
        ...
        if (Gdx.input.justTouched()) {
            ...
            if(selectBox.contains(selectTouch.x, selectTouch.y)) {
                game.setScreen(new ChooseTanksPlayer2(game));
                dispose();
            }
        }
